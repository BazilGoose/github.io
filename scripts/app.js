...
(function () {
    ...
    function DisplayOpportunityPage() {
        ...
        for (const signUpButton of signUpButtons) {
            signUpButton.addEventListener("click", function (event) {
                ...
                let opportunityId = document.getElementById("opportunityId");
    ...
    function handleAddEventClick(event) {
        ...
        let newEvent = new EventObj.Event(eventTitle, eventStartDate, eventEndDate, eventLocation, eventDesc, eventType);
     ...
     */
    function handleEditEventClick(event, eventEdit, page) {
        // Prevents default form submission behaviour
        event.preventDefault();
        // Get all the event attributes
        const eventTitle = document.getElementById("eventTitle").value;
    ...
    function DisplayStatisticPage() {
        ...
        //@ts-ignore
        let visitorsChart; // Move outside the function to persist
        //@ts-ignore
        let volunteerChart;
